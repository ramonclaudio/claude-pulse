...
body{font-family:'Geist Mono',monospace;background:#1f1f1e;color:#c3c2b7;padding:24px;max-width:1200px;margin:0 auto}
...
function bar(canvas,data,labelKey,valueKey,color){
  ...
  const pad=20;
  ctx.fillStyle="#7b7974";ctx.font="10px 'Geist Mono',monospace";
  data.forEach((d,i)=>{
    const x=pad+i*(bw+1);
  ...
  ctx.fillStyle="#5e5d59";ctx.font="9px 'Geist Mono',monospace";
