...
export function serveCommand(args: string[]): void {
  ...
  Bun.serve({
    ...
    routes: {
      ...
      "/fonts/GeistMono-Thin.ttf": Bun.file(FONTS_DIR + "/GeistMono-Thin.ttf"),
      "/fonts/GeistMono-ExtraLight.ttf": Bun.file(FONTS_DIR + "/GeistMono-ExtraLight.ttf"),
      "/fonts/GeistMono-Light.ttf": Bun.file(FONTS_DIR + "/GeistMono-Light.ttf"),
      "/fonts/GeistMono-Regular.ttf": Bun.file(FONTS_DIR + "/GeistMono-Regular.ttf"),
      "/fonts/GeistMono-Medium.ttf": Bun.file(FONTS_DIR + "/GeistMono-Medium.ttf"),
      "/fonts/GeistMono-SemiBold.ttf": Bun.file(FONTS_DIR + "/GeistMono-SemiBold.ttf"),
      "/fonts/GeistMono-Bold.ttf": Bun.file(FONTS_DIR + "/GeistMono-Bold.ttf"),
      "/fonts/GeistMono-ExtraBold.ttf": Bun.file(FONTS_DIR + "/GeistMono-ExtraBold.ttf"),
      "/fonts/GeistMono-Black.ttf": Bun.file(FONTS_DIR + "/GeistMono-Black.ttf"),
