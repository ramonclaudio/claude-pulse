...
export function serveCommand(args: string[]): void {
  ...
  Bun.serve({
    ...
    routes: {
      ...
      "/fonts/geist-mono-300.ttf": Bun.file(FONTS_DIR + "/GeistMono_300Light.ttf"),
      "/fonts/geist-mono-400.ttf": Bun.file(FONTS_DIR + "/GeistMono_400Regular.ttf"),
      "/fonts/geist-mono-500.ttf": Bun.file(FONTS_DIR + "/GeistMono_500Medium.ttf"),
      "/fonts/geist-mono-600.ttf": Bun.file(FONTS_DIR + "/GeistMono_600SemiBold.ttf"),
      "/fonts/geist-mono-700.ttf": Bun.file(FONTS_DIR + "/GeistMono_700Bold.ttf"),
      "/fonts/geist-mono-800.ttf": Bun.file(FONTS_DIR + "/GeistMono_800ExtraBold.ttf"),
